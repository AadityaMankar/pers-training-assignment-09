...
public class Movie implements java.io.Serializable {
    ...
    public static boolean addAllMoviesInDB(List<Movie> movies) {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/assignment9", "root", "toor");
    ...
    public static List<Movie> getMoviesReleasedInYear(List<Movie> movies, int year) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy");
        return movies.stream()
                .filter((movie) -> dateFormat.format(movie.releaseDate) == String.valueOf(year))
